...
var HeatmapOverlay = L.Layer.extend({
    ...
    changeOptions: function(config) {
        //this.configure(config);
        this.cfg = Util.merge(this.cfg, config);
        //h337._renderer.updateConfig(h337._config);
        //h337._coordinator.emit('renderall', h337._store._getInternalData());

        //h337.configure(config);
        //h337.repaint();
        this._draw();
    },
